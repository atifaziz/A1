...
// Generated: Mon, 19 Dec 2016 13:09:24 GMT
...
namespace A1
{
    ...
    partial struct Row : IEquatable<Row>, IComparable<Row>
    {
        ...
        public static Row operator +(Row col, int n) => new Row(col.Number + n);
        public static Row operator -(Row col, int n) => new Row(col.Number - n);
        ...
        public static implicit operator int(Row col) => col.Number;
    }
